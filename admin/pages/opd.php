...
<head>
    ...
    <style>
        ...
        /* Treatment selection styles - NEW DROPDOWN SYSTEM */
        .treatment-selection {
            background: #f8f9fa;
            border: 2px solid #e0e0e0;
            border-radius: 10px;
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <script>
        ...
        // Update patient details when patient is selected
        ...
        function resetForm() {
            ...
            addTreatmentRow(); // Add one row by default
        }

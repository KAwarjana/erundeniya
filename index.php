                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <strong
                                            class="">Erundeniya Ayurveda Hospital</strong></p>
                                    <h1 class="display-4 text-light mb-4 animated zoomIn slider text">Experience authentic Ayurveda treatments that restore balance, health, and peace of mind.</h1>
                                    <a href="services.php" class="btn text-light rounded-pill py-2 px-4 animated zoomIn slider--btn"
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <strong
                                            class="">Erundeniya Ayurveda Hospital</strong></p>
                                    <h1 class="display-4 text-light mb-4 animated zoomIn">Rooted in centuries of Ayurvedic wisdom, we bring holistic healing for body, mind, and soul.</h1>
                                    <a href="services.php" class="btn text-light rounded-pill py-2 px-4 animated zoomIn slider--btn"
                                        style="background-color: #014202;">Explore
                                        More</a>
                                </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <strong
                                            class="">Erundeniya Ayurveda Hospital</strong></p>
                                    <h1 class="display-4 text-light mb-4 animated zoomIn">Personalized therapies, herbal remedies, and natural care to rejuvenate your lifestyle.</h1>
                                    <a href="services.php" class="btn text-light rounded-pill py-2 px-4 animated zoomIn slider--btn"
                                        style="background-color: #014202;">Explore
                                        More</a>
                                </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <strong
                                            class="">Erundeniya Ayurveda Hospital</strong></p>
                                    <h1 class="display-4 text-light mb-4 animated zoomIn">At Erundeniya Ayurveda Hospital, every treatment is designed to nurture your inner harmony.</h1>
                                    <a href="services.php" class="btn text-light rounded-pill py-2 px-4 animated zoomIn slider--btn"
                                        style="background-color: #014202;">Explore
                                        More</a>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item">
                            ...
                            <h5 class="mb-3">Sciatica Treatments</h4>
                                ...
                                <a class="btn btn-light px-3" href="services.php">Read More<i
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid" src="img/home_artical.png" alt="">
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
                    ...
                    <a href="services.php#article" class="btn btn-primary rounded-pill py-3 px-5">Read More</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6 py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="py-5">
                        ...
                        <h5 class="fw-normal lh-base fst-italic text-white mt-5 mb-4">🌿 Where ancient wisdom meets
                            modern
                            wellness</h5>
                        <span class="fw-normal lh-base fst-italic mb-5 text-light">
                        ...
                        <div class="row g-4 mt-3 mb-0">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-light">Full Ayurvedic care</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-light">Modern, serene setting</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-light">Tailored therapies</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-light">Mind-body healing</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-5">
                        <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">
                            ...
                            <div class="testimonial-item">
                                ...
                                <p class="fs-5 mb-4">
                                    බටහිර වෛද්‍යක්‍රමය මගින් සුව කළ නොහැකි වූ මා දන්නා රෝගීන් රාශියක් මෙතුමිය විසින් සුව
                                    කර ඇත.
                                </p>
                                <div class="d-flex align-items-center">
                                    <img class="flex-shrink-0" src="img/testimonial-2.jpg" alt="">
                            ...
                            <div class="testimonial-item">
                                ...
                                <p class="fs-5 mb-4">
                                    වෙද්‍ය තුමියනි ඔබට මාව පිලිකාරෝගයෙන් සුවපත් කල පිනෙන් තවත් රෝගීන් දසදහසක් ගනනින්
                                    සුවපත් කිරීමට ශක්තිය ධෛර්ය ලැබේවා..ඔබතුමියට දීර්ගායුෂ ලැබේවා..
                                </p>
                                <div class="d-flex align-items-center">
                                    <img class="flex-shrink-0" src="img/testimonial-1.jpg" alt="">
                                    <div class="ps-3">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row g-5">
                        <div class="col-md-4 text-center wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p class="mb-2">info@erundeniyaayurveda.lk</p>
                        ...
                        <div class="col-md-4 text-center wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <p class="mb-2">A/55 Wedagedara , Erundeniya , Amithirigala , North</p>
